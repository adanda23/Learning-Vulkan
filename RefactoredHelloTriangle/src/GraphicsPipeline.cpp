...
std::vector<uint32_t> GraphicsPipeline::readFile(const std::string& filename) const {
...
VkShaderModule GraphicsPipeline::createShaderModule(VkDevice device, const std::vector<uint32_t>& code) const {
...
void GraphicsPipeline::create(VkDevice device, VkRenderPass renderPass, VkExtent2D swapChainExtent,
